...
//        //  默认加载新闻
//        List<Bnner_News.DataBean.SliderBean> bean = new ArrayList<>();
//        List<Bnner_News.DataBean.NewsBean> news = new ArrayList<>();
//        for (int i = 0; i < 4; i++) {
//            Bnner_News.DataBean.SliderBean sliderBean = new Bnner_News.DataBean.SliderBean("test" + i, "http://image.tianyancha.com/1a8f835a5106401d932bfaa058abb95e.jpg", "");
//            bean.add(sliderBean);
//            Bnner_News.DataBean.NewsBean newsBean = new Bnner_News.DataBean.NewsBean("中金债事智慧云2.0升级上线启动仪式在东莞盛大举行"
//                    , "", "http://image.tianyancha.com/662199ca720f4b50bd5ba4c3db9bb015.jpg", "http://www.wdcsoc.com/resources/news/news1.html", "2017-01-12");
//            news.add(newsBean);
//        }
//        Bnner_News.DataBean data = new Bnner_News.DataBean(bean, news);
//        bnner_news = new Bnner_News(data);
//        //默认轮播图
